...
## Overview
C Permutation Matrix Encryption (CPME) is an unconventional encryption algorithm which uses matrix multiplication to permute, or reorder, data stored in a byte-array.  
